...
const (
	UserService_AuthorizeUser_FullMethodName = "/user.UserService/AuthorizeUser"
)
...
func (UnimplementedUserServiceServer) AuthorizeUser(context.Context, *AuthorizeUserRequest) (*AuthorizeUserResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AuthorizeUser not implemented")
}
